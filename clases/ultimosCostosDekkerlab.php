...
class ultimosCostosDekkerlab extends ConexionsBd
{
     ...
     public function getData($search)
    {
        ...
        and CIDCLIENTEPROVEEDOR != 5714 
        and CIDCLIENTEPROVEEDOR != 5667
    ...
    public function getUltimoCostoPinturas($codigo, $año)
    {
    ...
    public function getUltimoCostoPinturasPeriodo($codigo, $año, $mes)
    {


        $sql = "WITH consulta as (SELECT  admpro.CIDPRODUCTO,admcos.CULTIMOCOSTOH,admmov.CIDDOCUMENTO,admcos.CFECHACOSTOH,MONTH(admcos.CFECHACOSTOH) as mes,YEAR(admcos.CFECHACOSTOH) as año,ROW_NUMBER() OVER(PARTITION BY admcos.CIDPRODUCTO,DATEADD(MONTH,DATEDIFF(MONTH,0,admcos.CFECHACOSTOH),0)
        ORDER BY admcos.CFECHACOSTOH desc) as filtro1 FROM [adPINTURAS2020SADEC].[dbo].[admProductos] as admpro LEFT OUTER JOIN [adPINTURAS2020SADEC].[dbo].[admCostosHistoricos] as admcos ON admpro.CIDPRODUCTO = admcos.CIDPRODUCTO LEFT OUTER JOIN [adPINTURAS2020SADEC].[dbo].[admMovimientos] as admmov ON admcos.CIDMOVIMIENTO = admmov.CIDMOVIMIENTO LEFT OUTER JOIN [adPINTURAS2020SADEC].[dbo].[admDocumentos] as admdoc ON admmov.CIDDOCUMENTO = admdoc.CIDDOCUMENTO WHERE YEAR(admcos.CFECHACOSTOH) IN($año) AND MONTH(admcos.CFECHACOSTOH)  = $mes AND admmov.CIDDOCUMENTODE = '19' and admpro.CCODIGOPRODUCTO = '" . $codigo . "' and admdoc.CIDCLIENTEPROVEEDOR != 19 and admcos.CULTIMOCOSTOH != 0 )
    ...
    public function getUltimoCostoDekkerlab($codigo, $año)
    {
        ...
        $sql = "WITH consulta as (SELECT  admpro.CIDPRODUCTO,admcos.CULTIMOCOSTOH,admmov.CIDDOCUMENTO,admcos.CFECHACOSTOH,MONTH(admcos.CFECHACOSTOH) as mes,YEAR(admcos.CFECHACOSTOH) as año,ROW_NUMBER() OVER(PARTITION BY admcos.CIDPRODUCTO,DATEADD(MONTH,DATEDIFF(MONTH,0,admcos.CFECHACOSTOH),0)
        ORDER BY admcos.CFECHACOSTOH desc) as filtro1 FROM [adDEKKERLAB].[dbo].[admProductos] as admpro LEFT OUTER JOIN [adDEKKERLAB].[dbo].[admCostosHistoricos] as admcos ON admpro.CIDPRODUCTO = admcos.CIDPRODUCTO LEFT OUTER JOIN [adDEKKERLAB].[dbo].[admMovimientos] as admmov ON admcos.CIDMOVIMIENTO = admmov.CIDMOVIMIENTO LEFT OUTER JOIN [adDEKKERLAB].[dbo].[admDocumentos] as admdoc ON admmov.CIDDOCUMENTO = admdoc.CIDDOCUMENTO WHERE YEAR(admcos.CFECHACOSTOH) IN($meses) AND admmov.CIDDOCUMENTODE = '19' and admpro.CCODIGOPRODUCTO = '" . $codigo . "' and admdoc.CIDCLIENTEPROVEEDOR != 5714 and admdoc.CIDCLIENTEPROVEEDOR != 5667 and admcos.CULTIMOCOSTOH != 0 )
    ...
    public function getUltimoCostoDekkerlabPeriodo($codigo, $año, $mes)
    {


        $sql = "WITH consulta as (SELECT  admpro.CIDPRODUCTO,admcos.CULTIMOCOSTOH,admmov.CIDDOCUMENTO,admcos.CFECHACOSTOH,MONTH(admcos.CFECHACOSTOH) as mes,YEAR(admcos.CFECHACOSTOH) as año,ROW_NUMBER() OVER(PARTITION BY admcos.CIDPRODUCTO,DATEADD(MONTH,DATEDIFF(MONTH,0,admcos.CFECHACOSTOH),0)
        ORDER BY admcos.CFECHACOSTOH desc) as filtro1 FROM [adDEKKERLAB].[dbo].[admProductos] as admpro LEFT OUTER JOIN [adDEKKERLAB].[dbo].[admCostosHistoricos] as admcos ON admpro.CIDPRODUCTO = admcos.CIDPRODUCTO LEFT OUTER JOIN [adDEKKERLAB].[dbo].[admMovimientos] as admmov ON admcos.CIDMOVIMIENTO = admmov.CIDMOVIMIENTO LEFT OUTER JOIN [adDEKKERLAB].[dbo].[admDocumentos] as admdoc ON admmov.CIDDOCUMENTO = admdoc.CIDDOCUMENTO WHERE YEAR(admcos.CFECHACOSTOH) IN($año) AND MONTH(admcos.CFECHACOSTOH)  = $mes AND admmov.CIDDOCUMENTODE = '19' and admpro.CCODIGOPRODUCTO = '" . $codigo . "' and admdoc.CIDCLIENTEPROVEEDOR != 5714 and admdoc.CIDCLIENTEPROVEEDOR != 5667 and admcos.CULTIMOCOSTOH != 0 )
