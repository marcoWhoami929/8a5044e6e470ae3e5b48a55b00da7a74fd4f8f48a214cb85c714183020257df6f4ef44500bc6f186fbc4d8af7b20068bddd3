            ...
            <table class="table table-responsive table-striped table-hover ">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <th><?= $row['Agente']; ?></th>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['Agente']; ?>','Agentes','','2013','13','')">$<?= number_format($row['2013'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['Agente']; ?>','Agentes','','2014','13','')">$<?= number_format($row['2014'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['Agente']; ?>','Agentes','','2015','13','')">$<?= number_format($row['2015'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['Agente']; ?>','Agentes','','2016','13','')">$<?= number_format($row['2016'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['Agente']; ?>','Agentes','','2017','13','')">$<?= number_format($row['2017'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['Agente']; ?>','Agentes','','2018','13','')">$<?= number_format($row['2018'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['Agente']; ?>','Agentes','','2019','13','')">$<?= number_format($row['2019'], 2) ?></td>
