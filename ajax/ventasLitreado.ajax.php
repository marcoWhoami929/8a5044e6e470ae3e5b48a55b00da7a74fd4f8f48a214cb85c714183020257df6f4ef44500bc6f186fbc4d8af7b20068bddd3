            ...
            <table class="table table-responsive table-striped table-hover " id="tableVentasProducto">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <th><?= $row['CCODIGOPRODUCTO']; ?></th>
                            <th><?= $row['CNOMBREPRODUCTO']; ?></th>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['1'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['2'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['3'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['4'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['5'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['6'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['7'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['8'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['9'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['10'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['11'], 2) ?> lt</td>
                            <td style="font-weight:bold;text-align:right"><?= number_format($row['12'], 2) ?> lt</td>
                ...
                <tfoot>
                    <tr>
                        <th>Total General</th>
                        <th></th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes1, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes2, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes3, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes4, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes5, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes6, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes7, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes8, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes9, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes10, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes11, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mes12, 2) ?> lt</th>
                        <th style="font-weight:bold;text-align:right"><?= number_format($mesTotales, 2) ?> </th>
                    </tr>
                </tfoot>
