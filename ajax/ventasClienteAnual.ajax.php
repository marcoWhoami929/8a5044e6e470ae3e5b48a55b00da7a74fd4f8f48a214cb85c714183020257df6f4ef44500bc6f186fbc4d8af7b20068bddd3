                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2013','13','')">$<?= number_format($row['2013'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2014','13','')">$<?= number_format($row['2014'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2015','13','')">$<?= number_format($row['2015'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2016','13','')">$<?= number_format($row['2016'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2017','13','')">$<?= number_format($row['2017'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2018','13','')">$<?= number_format($row['2018'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2019','13','')">$<?= number_format($row['2019'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2020','13','')">$<?= number_format($row['2020'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2021','13','')">$<?= number_format($row['2021'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2022','13','')">$<?= number_format($row['2022'], 2) ?></td>
                            <td style="font-weight:bold;text-align:right" onclick="redireccionAccionVentas('<?= $row['NombreCliente']; ?>','Clientes','','2023','13','')">$<?= number_format($row['2023'], 2) ?></td>
