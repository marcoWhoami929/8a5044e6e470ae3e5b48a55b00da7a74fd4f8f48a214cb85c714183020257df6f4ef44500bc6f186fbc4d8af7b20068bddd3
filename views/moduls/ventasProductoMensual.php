                                                ...
                                                <div class="col-sm-12">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h3>Ventas Por Producto Mensual</h3>
                                                        ...
                                                        <div class="card-block table-border-style">
                                                            <div class="table-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <label>Estatus</label>
                                                                                <span class="filter-icon"><i class="fa fa-filter"></i></span>
                                                                                <select class="form-control" id="estatus" onchange="cargarVentasProductoMonto(1,'','');cargarVentasProductoUnidades(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="campoOrden" onchange="cargarVentasProductoMonto(1,'','');cargarVentasProductoUnidades(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Orden</span>
                                                                                <select class="form-control" id="orden" onchange="cargarVentasProductoMonto(1,'','');cargarVentasProductoUnidades(1,'','');">
                                                                                    <option value="desc">Desc</option>
                                                                                    <option value="asc">Asc</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                                <a onclick="generarReporteMensual('ventasProductoMensual')"><i class="fa fa-file-excel-o fa-3x" aria-hidden="true"></i></a>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                ...
                                                                <div class="ventasProductoMontoData dataParams">

                                                                </div>
                                                                <div class="ventasProductoUnidadesData dataParams">
