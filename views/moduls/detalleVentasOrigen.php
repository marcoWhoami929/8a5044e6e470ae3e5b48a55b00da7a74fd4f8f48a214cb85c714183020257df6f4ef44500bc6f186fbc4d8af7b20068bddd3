                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            <div class="filter-group">
                                                                                <a href="ventasOrigenVentaMensual">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <label>Mostrar</label>
                                                                                <select class="form-control" id="per_page" onchange="cargarDetalleVentasClienteOrigen(1);">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="campoOrden" onchange="cargarDetalleVentasClienteOrigen(1);">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Orden</span>
                                                                                <select class="form-control" id="orden" onchange="cargarDetalleVentasClienteOrigen(1);">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <a onclick="generarReporteVentasClienteOrigen('ventasClienteOrigen')"><i class="fa fa-file-excel-o fa-3x" aria-hidden="true"></i></a>
                                                                            </div>
                                                                        </div>
