                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Ventas Por Producto Litreado</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block table-border-style">
                                                            <div class="table-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="anio" onchange="cargarVentasLitreadoMontoDiario(1,'','');cargarVentasLitreadoUnidadesDiario(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="semana" onchange="cargarVentasLitreadoMontoDiario(1,'','');cargarVentasLitreadoUnidadesDiario(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <label>Estatus</label>
                                                                                <span class="filter-icon"><i class="fa fa-filter"></i></span>
                                                                                <select class="form-control" id="estatus" onchange="cargarVentasLitreadoMontoDiario(1,'','');cargarVentasLitreadoUnidadesDiario(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Mostrar</span>
                                                                                <select class="form-control" id="per_page" onchange="cargarVentasLitreadoMontoDiario(1,'','');cargarVentasLitreadoUnidadesDiario(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="campoOrden" onchange="cargarVentasLitreadoMontoDiario(1,'','');cargarVentasLitreadoUnidadesDiario(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Orden</span>
                                                                                <select class="form-control" id="orden" onchange="cargarVentasLitreadoMontoDiario(1,'','');cargarVentasLitreadoUnidadesDiario(1,'','');">
                                                                                    <option value="desc">Desc</option>
                                                                                    <option value="asc">Asc</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                                <a onclick="generarReporteDiario('ventasLitreadoDiario')"><i class="fa fa-file-excel-o fa-3x" aria-hidden="true"></i></a>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                                <a onclick="limpiarFiltros('2')"><i class="fa fa-trash fa-3x" aria-hidden="true"></i></a>
                                                                            </div>
                                                                            <!----->
                                                                ...
                                                                <div class="ventasLitreadoMontoData dataParams">

                                                                </div>
                                                                <div class="ventasLitreadoUnidadesData dataParams">
