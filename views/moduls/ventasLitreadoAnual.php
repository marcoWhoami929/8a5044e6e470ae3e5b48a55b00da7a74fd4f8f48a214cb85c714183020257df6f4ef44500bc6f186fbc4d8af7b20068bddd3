                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="anio" onchange="cargarVentasLitreadoMontoAnual(1,'','');cargarVentasLitreadoUnidadesAnual(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <label>Estatus</label>
                                                                                <span class="filter-icon"><i class="fa fa-filter"></i></span>
                                                                                <select class="form-control" id="estatus" onchange="cargarVentasLitreadoMontoAnual(1,'','');cargarVentasLitreadoUnidadesAnual(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Mostrar</span>
                                                                                <select class="form-control" id="per_page" onchange="cargarVentasLitreadoMontoAnual(1,'','');cargarVentasLitreadoUnidadesAnual(1,'','');">
