                                                ...
                                                <div class="col-sm-12">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h3>Ventas Por Producto Anual</h3>
                                                        ...
                                                        <div class="card-block table-border-style">
                                                            <div class="table-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="estatus" onchange="cargarVentasProductoMontoAnual(1,'','');cargarVentasProductoUnidadesAnual(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="campoOrden" onchange="cargarVentasProductoMontoAnual(1,'','');cargarVentasProductoUnidadesAnual(1,'','');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Orden</span>
                                                                                <select class="form-control" id="orden" onchange="cargarVentasProductoMontoAnual(1,'','');cargarVentasProductoUnidadesAnual(1,'','');">
                                                                                    <option value="desc">Desc</option>
                                                                                    <option value="asc">Asc</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                                <a onclick="generarReporteAnual('ventasProductoAnual')"><i class="fa fa-file-excel-o fa-3x" aria-hidden="true"></i></a>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                ...
                                                                <div class="ventasProductoMontoAnualData dataParams">

                                                                </div>
                                                                <div class="ventasProductoUnidadesAnualData dataParams">
