                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Ventas Por Marca Anual</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block table-border-style">
                                                            <div class="table-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="estatus" onchange="cargarVentasMarcaAnual(1,'');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Mostrar</span>
                                                                                <select class="form-control" id="per_page" onchange="cargarVentasMarcaAnual(1,'');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="campoOrden" onchange="cargarVentasMarcaAnual(1,'');">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Orden</span>
                                                                                <select class="form-control" id="orden" onchange="cargarVentasMarcaAnual(1,'');">
                                                                                    <option value="desc">Desc</option>
                                                                                    <option value="asc">Asc</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                                <a onclick="generarReporteAnual('ventasMarcaAnual')"><i class="fa fa-file-excel-o fa-3x" aria-hidden="true"></i></a>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                ...
                                                                <div class="ventasMarcaAnualData dataParams">
